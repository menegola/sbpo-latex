...
\textbf{KEYWORDS}. First keyword. Second keyword. Last keyword. Main area (choose between those in the areas window).
...
\textbf{PALAVRAS CHAVE}. Primeira palavra chave. Segunda palavra chave. Última Palavra chave. Área de classificação principal (escolher uma na janela de áreas)
